...
for cat in ["train", "test", "val"]:   
    dataset = datasets.ImageFolder(f"archive_smallset/{cat}", transform=transform)
...
train_dataset = MyData(datasets.ImageFolder("archive_smallset/train", transform=transform))
val_dataset   = MyData(datasets.ImageFolder("archive_smallset/val",   transform=transform_eval))
test_dataset  = MyData(datasets.ImageFolder("archive_smallset/test",  transform=transform_eval))
